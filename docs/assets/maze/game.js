...
// include: /tmp/tmp3umgu9tj.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/maze/game.data';
...
Module['FS_createPath']("/resources", "maze", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/web/maze/game.data');

      };
      Module['addRunDependency']('datafile_build/web/maze/game.data');
    ...
    loadPackage({"files": [{"filename": "/config/default.ini", "start": 0, "end": 4531}, {"filename": "/config/maze.ini", "start": 4531, "end": 5154}, {"filename": "/config/maze_web.ini", "start": 5154, "end": 5274}, {"filename": "/resources/maze/maze_weights.bin", "start": 5274, "end": 3281050}, {"filename": "/resources/shared/JetBrainsMono-Bold.ttf", "start": 3281050, "end": 3395878}, {"filename": "/resources/shared/JetBrainsMono-Medium.ttf", "start": 3395878, "end": 3510798}, {"filename": "/resources/shared/JetBrainsMono-Regular.ttf", "start": 3510798, "end": 3625702}, {"filename": "/resources/shared/JetBrainsMono-SemiBold.ttf", "start": 3625702, "end": 3740602}, {"filename": "/resources/shared/Montserrat-Regular.ttf", "start": 3740602, "end": 4071550}, {"filename": "/resources/shared/Roboto-Italic.ttf", "start": 4071550, "end": 4223758}, {"filename": "/resources/shared/Roboto-Regular.ttf", "start": 4223758, "end": 4369762}, {"filename": "/resources/shared/puffer.glb", "start": 4369762, "end": 5569386}, {"filename": "/resources/shared/puffers.png", "start": 5569386, "end": 5866524}, {"filename": "/resources/shared/puffers_128.png", "start": 5866524, "end": 5889430}], "remote_package_size": 5889430});

  })();

// end include: /tmp/tmp3umgu9tj.js
// include: /tmp/tmpj4tetcw9.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpj4tetcw9.js
// include: /tmp/tmpmebgojz5.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpmebgojz5.js
...
var ASM_CONSTS = {
  35528: () => { if (document.fullscreenElement) return 1; },  
 35574: () => { return document.getElementById('canvas').width; },  
 35626: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35694: () => { document.exitFullscreen(); },  
 35721: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 35794: () => { if (document.fullscreenElement) return 1; },  
 35840: () => { return document.getElementById('canvas').width; },  
 35892: () => { return screen.width; },  
 35917: () => { document.exitFullscreen(); },  
 35944: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36077: () => { return window.innerWidth; },  
 36103: () => { return window.innerHeight; },  
 36130: () => { if (document.fullscreenElement) return 1; },  
 36176: () => { return document.getElementById('canvas').width; },  
 36228: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36296: () => { if (document.fullscreenElement) return 1; },  
 36342: () => { return document.getElementById('canvas').width; },  
 36394: () => { return screen.width; },  
 36419: () => { return window.innerWidth; },  
 36445: () => { return window.innerHeight; },  
 36472: () => { if (document.fullscreenElement) return 1; },  
 36518: () => { return document.getElementById('canvas').width; },  
 36570: () => { return screen.width; },  
 36595: () => { document.exitFullscreen(); },  
 36622: () => { if (document.fullscreenElement) return 1; },  
 36668: () => { return document.getElementById('canvas').width; },  
 36720: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36788: () => { document.exitFullscreen(); },  
 36815: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 36873: () => { return screen.width; },  
 36898: () => { return screen.height; },  
 36924: () => { return window.screenX; },  
 36951: () => { return window.screenY; },  
 36978: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37031: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 37102: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 37159: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 37415: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 37486: () => { if (document.fullscreenElement) return 1; },  
 37532: () => { return window.innerWidth; },  
 37558: () => { return window.innerHeight; },  
 37585: () => { if (document.pointerLockElement) return 1; }
};
