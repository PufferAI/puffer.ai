...
Module['FS_createPath']("/resources", "shared", true, true);
    ...
    loadPackage({"files": [{"filename": "/config/default.ini", "start": 0, "end": 4531}, {"filename": "/config/drone.ini", "start": 4531, "end": 6786}, {"filename": "/config/drone_web.ini", "start": 6786, "end": 6886}, {"filename": "/resources/drone/drone_weights.bin", "start": 6886, "end": 111862}, {"filename": "/resources/shared/JetBrainsMono-Bold.ttf", "start": 111862, "end": 226690}, {"filename": "/resources/shared/JetBrainsMono-Medium.ttf", "start": 226690, "end": 341610}, {"filename": "/resources/shared/JetBrainsMono-Regular.ttf", "start": 341610, "end": 456514}, {"filename": "/resources/shared/JetBrainsMono-SemiBold.ttf", "start": 456514, "end": 571414}, {"filename": "/resources/shared/Montserrat-Regular.ttf", "start": 571414, "end": 902362}, {"filename": "/resources/shared/Roboto-Italic.ttf", "start": 902362, "end": 1054570}, {"filename": "/resources/shared/Roboto-Regular.ttf", "start": 1054570, "end": 1200574}, {"filename": "/resources/shared/puffer.glb", "start": 1200574, "end": 2400198}, {"filename": "/resources/shared/puffers.png", "start": 2400198, "end": 2697336}, {"filename": "/resources/shared/puffers_128.png", "start": 2697336, "end": 2720242}], "remote_package_size": 2720242});

  })();

// end include: /tmp/tmpb0a52gp3.js
// include: /tmp/tmpa1ykpet6.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpa1ykpet6.js
// include: /tmp/tmpippp5k49.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpippp5k49.js
...
var ASM_CONSTS = {
  44552: () => { if (document.fullscreenElement) return 1; },  
 44598: () => { return document.getElementById('canvas').width; },  
 44650: () => { return parseInt(document.getElementById('canvas').style.width); },  
 44718: () => { document.exitFullscreen(); },  
 44745: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 44818: () => { if (document.fullscreenElement) return 1; },  
 44864: () => { return document.getElementById('canvas').width; },  
 44916: () => { return screen.width; },  
 44941: () => { document.exitFullscreen(); },  
 44968: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 45101: () => { return window.innerWidth; },  
 45127: () => { return window.innerHeight; },  
 45154: () => { if (document.fullscreenElement) return 1; },  
 45200: () => { return document.getElementById('canvas').width; },  
 45252: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45320: () => { if (document.fullscreenElement) return 1; },  
 45366: () => { return document.getElementById('canvas').width; },  
 45418: () => { return screen.width; },  
 45443: () => { return window.innerWidth; },  
 45469: () => { return window.innerHeight; },  
 45496: () => { if (document.fullscreenElement) return 1; },  
 45542: () => { return document.getElementById('canvas').width; },  
 45594: () => { return screen.width; },  
 45619: () => { document.exitFullscreen(); },  
 45646: () => { if (document.fullscreenElement) return 1; },  
 45692: () => { return document.getElementById('canvas').width; },  
 45744: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45812: () => { document.exitFullscreen(); },  
 45839: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 45897: () => { return screen.width; },  
 45922: () => { return screen.height; },  
 45948: () => { return window.screenX; },  
 45975: () => { return window.screenY; },  
 46002: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 46055: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 46126: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 46183: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 46439: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 46510: () => { if (document.fullscreenElement) return 1; },  
 46556: () => { return window.innerWidth; },  
 46582: () => { return window.innerHeight; },  
 46609: () => { if (document.pointerLockElement) return 1; }
};
