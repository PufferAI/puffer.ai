...
// include: /tmp/tmpb0v02juc.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/drone/game.data';
...
Module['FS_createPath']("/resources", "drone", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/web/drone/game.data');

      };
      Module['addRunDependency']('datafile_build/web/drone/game.data');
    ...
    loadPackage({"files": [{"filename": "/config/default.ini", "start": 0, "end": 5087}, {"filename": "/config/drone.ini", "start": 5087, "end": 7027}, {"filename": "/config/drone_web.ini", "start": 7027, "end": 7127}, {"filename": "/resources/drone/drone_weights.bin", "start": 7127, "end": 112615}, {"filename": "/resources/shared/JetBrainsMono-Bold.ttf", "start": 112615, "end": 227443}, {"filename": "/resources/shared/JetBrainsMono-Medium.ttf", "start": 227443, "end": 342363}, {"filename": "/resources/shared/JetBrainsMono-Regular.ttf", "start": 342363, "end": 457267}, {"filename": "/resources/shared/JetBrainsMono-SemiBold.ttf", "start": 457267, "end": 572167}, {"filename": "/resources/shared/Montserrat-Regular.ttf", "start": 572167, "end": 903115}, {"filename": "/resources/shared/Roboto-Italic.ttf", "start": 903115, "end": 1055323}, {"filename": "/resources/shared/Roboto-Regular.ttf", "start": 1055323, "end": 1201327}, {"filename": "/resources/shared/puffer.glb", "start": 1201327, "end": 2400951}, {"filename": "/resources/shared/puffers.png", "start": 2400951, "end": 2698089}, {"filename": "/resources/shared/puffers_128.png", "start": 2698089, "end": 2720995}], "remote_package_size": 2720995});

  })();

// end include: /tmp/tmpb0v02juc.js
// include: /tmp/tmpl4auvkv0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpl4auvkv0.js
// include: /tmp/tmpfkddryk9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpfkddryk9.js
...
var ASM_CONSTS = {
  44568: () => { if (document.fullscreenElement) return 1; },  
 44614: () => { return document.getElementById('canvas').width; },  
 44666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 44734: () => { document.exitFullscreen(); },  
 44761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 44834: () => { if (document.fullscreenElement) return 1; },  
 44880: () => { return document.getElementById('canvas').width; },  
 44932: () => { return screen.width; },  
 44957: () => { document.exitFullscreen(); },  
 44984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 45117: () => { return window.innerWidth; },  
 45143: () => { return window.innerHeight; },  
 45170: () => { if (document.fullscreenElement) return 1; },  
 45216: () => { return document.getElementById('canvas').width; },  
 45268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45336: () => { if (document.fullscreenElement) return 1; },  
 45382: () => { return document.getElementById('canvas').width; },  
 45434: () => { return screen.width; },  
 45459: () => { return window.innerWidth; },  
 45485: () => { return window.innerHeight; },  
 45512: () => { if (document.fullscreenElement) return 1; },  
 45558: () => { return document.getElementById('canvas').width; },  
 45610: () => { return screen.width; },  
 45635: () => { document.exitFullscreen(); },  
 45662: () => { if (document.fullscreenElement) return 1; },  
 45708: () => { return document.getElementById('canvas').width; },  
 45760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45828: () => { document.exitFullscreen(); },  
 45855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 45913: () => { return screen.width; },  
 45938: () => { return screen.height; },  
 45964: () => { return window.screenX; },  
 45991: () => { return window.screenY; },  
 46018: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 46071: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 46142: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 46199: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 46455: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 46526: () => { if (document.fullscreenElement) return 1; },  
 46572: () => { return window.innerWidth; },  
 46598: () => { return window.innerHeight; },  
 46625: () => { if (document.pointerLockElement) return 1; }
};
