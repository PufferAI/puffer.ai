...
Module['FS_createPath']("/resources", "shared", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/enduro/enduro_spritesheet.png", "start": 0, "end": 7485}, {"filename": "/resources/enduro/enduro_weights.bin", "start": 7485, "end": 576357}, {"filename": "/resources/shared/puffer.glb", "start": 576357, "end": 1775981}, {"filename": "/resources/shared/puffers.png", "start": 1775981, "end": 2073119}, {"filename": "/resources/shared/puffers_128.png", "start": 2073119, "end": 2096025}], "remote_package_size": 2096025});

  })();

// end include: /tmp/tmp6xwr0bf8.js
// include: /tmp/tmp4rb2p5by.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp4rb2p5by.js
// include: /tmp/tmph5r64jso.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmph5r64jso.js
...
var ASM_CONSTS = {
  36376: () => { if (document.fullscreenElement) return 1; },  
 36422: () => { return document.getElementById('canvas').width; },  
 36474: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36542: () => { document.exitFullscreen(); },  
 36569: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 36642: () => { if (document.fullscreenElement) return 1; },  
 36688: () => { return document.getElementById('canvas').width; },  
 36740: () => { return screen.width; },  
 36765: () => { document.exitFullscreen(); },  
 36792: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36925: () => { return window.innerWidth; },  
 36951: () => { return window.innerHeight; },  
 36978: () => { if (document.fullscreenElement) return 1; },  
 37024: () => { return document.getElementById('canvas').width; },  
 37076: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37144: () => { if (document.fullscreenElement) return 1; },  
 37190: () => { return document.getElementById('canvas').width; },  
 37242: () => { return screen.width; },  
 37267: () => { return window.innerWidth; },  
 37293: () => { return window.innerHeight; },  
 37320: () => { if (document.fullscreenElement) return 1; },  
 37366: () => { return document.getElementById('canvas').width; },  
 37418: () => { return screen.width; },  
 37443: () => { document.exitFullscreen(); },  
 37470: () => { if (document.fullscreenElement) return 1; },  
 37516: () => { return document.getElementById('canvas').width; },  
 37568: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37636: () => { document.exitFullscreen(); },  
 37663: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 37721: () => { return screen.width; },  
 37746: () => { return screen.height; },  
 37772: () => { return window.screenX; },  
 37799: () => { return window.screenY; },  
 37826: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37879: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 37950: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 38007: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 38263: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 38334: () => { if (document.fullscreenElement) return 1; },  
 38380: () => { return window.innerWidth; },  
 38406: () => { return window.innerHeight; },  
 38433: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
