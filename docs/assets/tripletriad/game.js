...
// include: /tmp/tmpf886186p.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/tripletriad/game.data';
...
Module['FS_createPath']("/resources", "tripletriad", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/tripletriad/game.data');

      };
      Module['addRunDependency']('datafile_build_web/tripletriad/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffers.png", "start": 0, "end": 297138}, {"filename": "/resources/shared/puffers_128.png", "start": 297138, "end": 320044}, {"filename": "/resources/tripletriad/tripletriad_weights.bin", "start": 320044, "end": 915048}], "remote_package_size": 915048});

  })();

// end include: /tmp/tmpf886186p.js
// include: /tmp/tmp23dqou0q.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp23dqou0q.js
// include: /tmp/tmpv719dbmk.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpv719dbmk.js
...
var ASM_CONSTS = {
  30640: () => { if (document.fullscreenElement) return 1; },  
 30686: () => { return document.getElementById('canvas').width; },  
 30738: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30806: () => { document.exitFullscreen(); },  
 30833: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30906: () => { if (document.fullscreenElement) return 1; },  
 30952: () => { return document.getElementById('canvas').width; },  
 31004: () => { return screen.width; },  
 31029: () => { document.exitFullscreen(); },  
 31056: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31189: () => { return window.innerWidth; },  
 31215: () => { return window.innerHeight; },  
 31242: () => { if (document.fullscreenElement) return 1; },  
 31288: () => { return document.getElementById('canvas').width; },  
 31340: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31408: () => { if (document.fullscreenElement) return 1; },  
 31454: () => { return document.getElementById('canvas').width; },  
 31506: () => { return screen.width; },  
 31531: () => { return window.innerWidth; },  
 31557: () => { return window.innerHeight; },  
 31584: () => { if (document.fullscreenElement) return 1; },  
 31630: () => { return document.getElementById('canvas').width; },  
 31682: () => { return screen.width; },  
 31707: () => { document.exitFullscreen(); },  
 31734: () => { if (document.fullscreenElement) return 1; },  
 31780: () => { return document.getElementById('canvas').width; },  
 31832: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31900: () => { document.exitFullscreen(); },  
 31927: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 31985: () => { return screen.width; },  
 32010: () => { return screen.height; },  
 32036: () => { return window.screenX; },  
 32063: () => { return window.screenY; },  
 32090: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32143: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 32214: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 32271: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32527: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 32598: () => { if (document.fullscreenElement) return 1; },  
 32644: () => { return window.innerWidth; },  
 32670: () => { return window.innerHeight; },  
 32697: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
