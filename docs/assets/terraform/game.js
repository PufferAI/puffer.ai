...
// include: /tmp/tmpwskvtv8g.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/terraform/game.data';
...
Module['FS_createPath']("/resources", "terraform", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/web/terraform/game.data');

      };
      Module['addRunDependency']('datafile_build/web/terraform/game.data');
    ...
    loadPackage({"files": [{"filename": "/config/default.ini", "start": 0, "end": 4531}, {"filename": "/config/terraform.ini", "start": 4531, "end": 5542}, {"filename": "/config/terraform_web.ini", "start": 5542, "end": 5672}, {"filename": "/resources/shared/JetBrainsMono-Bold.ttf", "start": 5672, "end": 120500}, {"filename": "/resources/shared/JetBrainsMono-Medium.ttf", "start": 120500, "end": 235420}, {"filename": "/resources/shared/JetBrainsMono-Regular.ttf", "start": 235420, "end": 350324}, {"filename": "/resources/shared/JetBrainsMono-SemiBold.ttf", "start": 350324, "end": 465224}, {"filename": "/resources/shared/Montserrat-Regular.ttf", "start": 465224, "end": 796172}, {"filename": "/resources/shared/Roboto-Italic.ttf", "start": 796172, "end": 948380}, {"filename": "/resources/shared/Roboto-Regular.ttf", "start": 948380, "end": 1094384}, {"filename": "/resources/shared/puffer.glb", "start": 1094384, "end": 2294008}, {"filename": "/resources/shared/puffers.png", "start": 2294008, "end": 2591146}, {"filename": "/resources/shared/puffers_128.png", "start": 2591146, "end": 2614052}, {"filename": "/resources/terraform/dozer.glb", "start": 2614052, "end": 3191008}, {"filename": "/resources/terraform/perlin.jpg", "start": 3191008, "end": 3240160}, {"filename": "/resources/terraform/shader_100.fs", "start": 3240160, "end": 3242956}, {"filename": "/resources/terraform/shader_100.vs", "start": 3242956, "end": 3243377}, {"filename": "/resources/terraform/shader_330.fs", "start": 3243377, "end": 3247226}, {"filename": "/resources/terraform/shader_330.vs", "start": 3247226, "end": 3247812}, {"filename": "/resources/terraform/target_shader_100.fs", "start": 3247812, "end": 3249016}, {"filename": "/resources/terraform/target_shader_330.fs", "start": 3249016, "end": 3250701}, {"filename": "/resources/terraform/target_shader_330.vs", "start": 3250701, "end": 3251309}, {"filename": "/resources/terraform/terraform_weights.bin", "start": 3251309, "end": 4798061}], "remote_package_size": 4798061});

  })();

// end include: /tmp/tmpwskvtv8g.js
// include: /tmp/tmpty6ilnr9.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpty6ilnr9.js
// include: /tmp/tmpfakrp69d.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpfakrp69d.js
...
// Begin JS library code
  ...
  var _puf_web_vsync = () => Asyncify.handleSleep((wakeUp) => {
      requestAnimationFrame(() => wakeUp());
    });
  _puf_web_vsync.isAsync = true;
...
var ASM_CONSTS = {
  51568: () => { if (document.fullscreenElement) return 1; },  
 51614: () => { return document.getElementById('canvas').width; },  
 51666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 51734: () => { document.exitFullscreen(); },  
 51761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 51834: () => { if (document.fullscreenElement) return 1; },  
 51880: () => { return document.getElementById('canvas').width; },  
 51932: () => { return screen.width; },  
 51957: () => { document.exitFullscreen(); },  
 51984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 52117: () => { return window.innerWidth; },  
 52143: () => { return window.innerHeight; },  
 52170: () => { if (document.fullscreenElement) return 1; },  
 52216: () => { return document.getElementById('canvas').width; },  
 52268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 52336: () => { if (document.fullscreenElement) return 1; },  
 52382: () => { return document.getElementById('canvas').width; },  
 52434: () => { return screen.width; },  
 52459: () => { return window.innerWidth; },  
 52485: () => { return window.innerHeight; },  
 52512: () => { if (document.fullscreenElement) return 1; },  
 52558: () => { return document.getElementById('canvas').width; },  
 52610: () => { return screen.width; },  
 52635: () => { document.exitFullscreen(); },  
 52662: () => { if (document.fullscreenElement) return 1; },  
 52708: () => { return document.getElementById('canvas').width; },  
 52760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 52828: () => { document.exitFullscreen(); },  
 52855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 52913: () => { return screen.width; },  
 52938: () => { return screen.height; },  
 52964: () => { return window.screenX; },  
 52991: () => { return window.screenY; },  
 53018: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 53071: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 53142: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 53199: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 53455: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 53526: () => { if (document.fullscreenElement) return 1; },  
 53572: () => { return window.innerWidth; },  
 53598: () => { return window.innerHeight; },  
 53625: () => { if (document.pointerLockElement) return 1; }
};
