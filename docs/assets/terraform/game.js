...
// include: /tmp/tmp9p5kve5c.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/terraform/game.data';
...
Module['FS_createPath']("/resources", "terraform", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/terraform/game.data');

      };
      Module['addRunDependency']('datafile_build_web/terraform/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffer.glb", "start": 0, "end": 1199624}, {"filename": "/resources/shared/puffers.png", "start": 1199624, "end": 1496762}, {"filename": "/resources/shared/puffers_128.png", "start": 1496762, "end": 1519668}, {"filename": "/resources/terraform/dozer.glb", "start": 1519668, "end": 2096624}, {"filename": "/resources/terraform/perlin.jpg", "start": 2096624, "end": 2145776}, {"filename": "/resources/terraform/puffer_terraform_weights.bin", "start": 2145776, "end": 12053032}, {"filename": "/resources/terraform/shader_100.fs", "start": 12053032, "end": 12055828}, {"filename": "/resources/terraform/shader_100.vs", "start": 12055828, "end": 12056249}, {"filename": "/resources/terraform/shader_330.fs", "start": 12056249, "end": 12060098}, {"filename": "/resources/terraform/shader_330.vs", "start": 12060098, "end": 12060684}, {"filename": "/resources/terraform/target_shader_100.fs", "start": 12060684, "end": 12061888}, {"filename": "/resources/terraform/target_shader_330.fs", "start": 12061888, "end": 12063573}, {"filename": "/resources/terraform/target_shader_330.vs", "start": 12063573, "end": 12064181}], "remote_package_size": 12064181});

  })();

// end include: /tmp/tmp9p5kve5c.js
// include: /tmp/tmpk2p2u9ev.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpk2p2u9ev.js
// include: /tmp/tmptrtx94x9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmptrtx94x9.js
...
var ASM_CONSTS = {
  50848: () => { if (document.fullscreenElement) return 1; },  
 50894: () => { return document.getElementById('canvas').width; },  
 50946: () => { return parseInt(document.getElementById('canvas').style.width); },  
 51014: () => { document.exitFullscreen(); },  
 51041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 51114: () => { if (document.fullscreenElement) return 1; },  
 51160: () => { return document.getElementById('canvas').width; },  
 51212: () => { return screen.width; },  
 51237: () => { document.exitFullscreen(); },  
 51264: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 51397: () => { return window.innerWidth; },  
 51423: () => { return window.innerHeight; },  
 51450: () => { if (document.fullscreenElement) return 1; },  
 51496: () => { return document.getElementById('canvas').width; },  
 51548: () => { return parseInt(document.getElementById('canvas').style.width); },  
 51616: () => { if (document.fullscreenElement) return 1; },  
 51662: () => { return document.getElementById('canvas').width; },  
 51714: () => { return screen.width; },  
 51739: () => { return window.innerWidth; },  
 51765: () => { return window.innerHeight; },  
 51792: () => { if (document.fullscreenElement) return 1; },  
 51838: () => { return document.getElementById('canvas').width; },  
 51890: () => { return screen.width; },  
 51915: () => { document.exitFullscreen(); },  
 51942: () => { if (document.fullscreenElement) return 1; },  
 51988: () => { return document.getElementById('canvas').width; },  
 52040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 52108: () => { document.exitFullscreen(); },  
 52135: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 52193: () => { return screen.width; },  
 52218: () => { return screen.height; },  
 52244: () => { return window.screenX; },  
 52271: () => { return window.screenY; },  
 52298: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 52351: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 52422: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 52479: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 52735: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 52806: () => { if (document.fullscreenElement) return 1; },  
 52852: () => { return window.innerWidth; },  
 52878: () => { return window.innerHeight; },  
 52905: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
