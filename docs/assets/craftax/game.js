...
// include: /tmp/tmp32o8jdk4.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/craftax/game.data';
...
Module['FS_createPath']("/resources", "craftax", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/web/craftax/game.data');

      };
      Module['addRunDependency']('datafile_build/web/craftax/game.data');
    ...
    loadPackage({"files": [{"filename": "/config/craftax.ini", "start": 0, "end": 620}, {"filename": "/config/craftax_web.ini", "start": 620, "end": 847}, {"filename": "/config/default.ini", "start": 847, "end": 5378}, {"filename": "/resources/craftax/craftax_weights.bin", "start": 5378, "end": 4093826}, {"filename": "/resources/craftax/textures.png", "start": 4093826, "end": 4114753}, {"filename": "/resources/shared/JetBrainsMono-Bold.ttf", "start": 4114753, "end": 4229581}, {"filename": "/resources/shared/JetBrainsMono-Medium.ttf", "start": 4229581, "end": 4344501}, {"filename": "/resources/shared/JetBrainsMono-Regular.ttf", "start": 4344501, "end": 4459405}, {"filename": "/resources/shared/JetBrainsMono-SemiBold.ttf", "start": 4459405, "end": 4574305}, {"filename": "/resources/shared/Montserrat-Regular.ttf", "start": 4574305, "end": 4905253}, {"filename": "/resources/shared/Roboto-Italic.ttf", "start": 4905253, "end": 5057461}, {"filename": "/resources/shared/Roboto-Regular.ttf", "start": 5057461, "end": 5203465}, {"filename": "/resources/shared/puffer.glb", "start": 5203465, "end": 6403089}, {"filename": "/resources/shared/puffers.png", "start": 6403089, "end": 6700227}, {"filename": "/resources/shared/puffers_128.png", "start": 6700227, "end": 6723133}], "remote_package_size": 6723133});

  })();

// end include: /tmp/tmp32o8jdk4.js
// include: /tmp/tmprdu1m_fs.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmprdu1m_fs.js
// include: /tmp/tmpow85u54h.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpow85u54h.js
...
var ASM_CONSTS = {
  41848: () => { if (document.fullscreenElement) return 1; },  
 41894: () => { return document.getElementById('canvas').width; },  
 41946: () => { return parseInt(document.getElementById('canvas').style.width); },  
 42014: () => { document.exitFullscreen(); },  
 42041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 42114: () => { if (document.fullscreenElement) return 1; },  
 42160: () => { return document.getElementById('canvas').width; },  
 42212: () => { return screen.width; },  
 42237: () => { document.exitFullscreen(); },  
 42264: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 42397: () => { return window.innerWidth; },  
 42423: () => { return window.innerHeight; },  
 42450: () => { if (document.fullscreenElement) return 1; },  
 42496: () => { return document.getElementById('canvas').width; },  
 42548: () => { return parseInt(document.getElementById('canvas').style.width); },  
 42616: () => { if (document.fullscreenElement) return 1; },  
 42662: () => { return document.getElementById('canvas').width; },  
 42714: () => { return screen.width; },  
 42739: () => { return window.innerWidth; },  
 42765: () => { return window.innerHeight; },  
 42792: () => { if (document.fullscreenElement) return 1; },  
 42838: () => { return document.getElementById('canvas').width; },  
 42890: () => { return screen.width; },  
 42915: () => { document.exitFullscreen(); },  
 42942: () => { if (document.fullscreenElement) return 1; },  
 42988: () => { return document.getElementById('canvas').width; },  
 43040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 43108: () => { document.exitFullscreen(); },  
 43135: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 43193: () => { return screen.width; },  
 43218: () => { return screen.height; },  
 43244: () => { return window.screenX; },  
 43271: () => { return window.screenY; },  
 43298: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 43351: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 43422: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 43479: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 43735: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 43806: () => { if (document.fullscreenElement) return 1; },  
 43852: () => { return window.innerWidth; },  
 43878: () => { return window.innerHeight; },  
 43905: () => { if (document.pointerLockElement) return 1; }
};
