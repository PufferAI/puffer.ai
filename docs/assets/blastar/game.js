...
// include: /tmp/tmpf3pjpisj.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/blastar/game.data';
...
Module['FS_createPath']("/resources", "blastar", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/blastar/game.data');

      };
      Module['addRunDependency']('datafile_build_web/blastar/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/blastar/blastar_weights.bin", "start": 0, "end": 537628}, {"filename": "/resources/blastar/enemy_bullet.png", "start": 537628, "end": 538195}, {"filename": "/resources/blastar/enemy_ship.png", "start": 538195, "end": 538803}, {"filename": "/resources/blastar/player_bullet.png", "start": 538803, "end": 539369}, {"filename": "/resources/blastar/player_death_explosion.png", "start": 539369, "end": 540004}, {"filename": "/resources/blastar/player_ship.png", "start": 540004, "end": 540577}, {"filename": "/resources/shared/puffer.glb", "start": 540577, "end": 1740201}, {"filename": "/resources/shared/puffers.png", "start": 1740201, "end": 2037339}, {"filename": "/resources/shared/puffers_128.png", "start": 2037339, "end": 2060245}], "remote_package_size": 2060245});

  })();

// end include: /tmp/tmpf3pjpisj.js
// include: /tmp/tmp03e8ddw4.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp03e8ddw4.js
// include: /tmp/tmpalz5u84s.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpalz5u84s.js
...
var ASM_CONSTS = {
  34680: () => { if (document.fullscreenElement) return 1; },  
 34726: () => { return document.getElementById('canvas').width; },  
 34778: () => { return parseInt(document.getElementById('canvas').style.width); },  
 34846: () => { document.exitFullscreen(); },  
 34873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 34946: () => { if (document.fullscreenElement) return 1; },  
 34992: () => { return document.getElementById('canvas').width; },  
 35044: () => { return screen.width; },  
 35069: () => { document.exitFullscreen(); },  
 35096: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35229: () => { return window.innerWidth; },  
 35255: () => { return window.innerHeight; },  
 35282: () => { if (document.fullscreenElement) return 1; },  
 35328: () => { return document.getElementById('canvas').width; },  
 35380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35448: () => { if (document.fullscreenElement) return 1; },  
 35494: () => { return document.getElementById('canvas').width; },  
 35546: () => { return screen.width; },  
 35571: () => { return window.innerWidth; },  
 35597: () => { return window.innerHeight; },  
 35624: () => { if (document.fullscreenElement) return 1; },  
 35670: () => { return document.getElementById('canvas').width; },  
 35722: () => { return screen.width; },  
 35747: () => { document.exitFullscreen(); },  
 35774: () => { if (document.fullscreenElement) return 1; },  
 35820: () => { return document.getElementById('canvas').width; },  
 35872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35940: () => { document.exitFullscreen(); },  
 35967: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 36025: () => { return screen.width; },  
 36050: () => { return screen.height; },  
 36076: () => { return window.screenX; },  
 36103: () => { return window.screenY; },  
 36130: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 36183: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 36254: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 36311: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36567: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 36638: () => { if (document.fullscreenElement) return 1; },  
 36684: () => { return window.innerWidth; },  
 36710: () => { return window.innerHeight; },  
 36737: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
