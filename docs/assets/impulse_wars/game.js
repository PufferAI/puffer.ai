...
// include: /tmp/tmpbzqpt2dv.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/impulse_wars/game.data';
...
Module['FS_createPath']("/resources", "impulse_wars", true, true);
Module['FS_createPath']("/resources/impulse_wars", "shaders", true, true);
Module['FS_createPath']("/resources/impulse_wars/shaders", "gls100", true, true);
Module['FS_createPath']("/resources/impulse_wars/shaders", "gls330", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/impulse_wars/game.data');

      };
      Module['addRunDependency']('datafile_build_web/impulse_wars/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/impulse_wars/create_texture.py", "start": 0, "end": 858}, {"filename": "/resources/impulse_wars/shaders/gls100/bloom.fs", "start": 858, "end": 2563}, {"filename": "/resources/impulse_wars/shaders/gls100/bloom.vs", "start": 2563, "end": 3312}, {"filename": "/resources/impulse_wars/shaders/gls100/blur.fs", "start": 3312, "end": 5115}, {"filename": "/resources/impulse_wars/shaders/gls100/blur.vs", "start": 5115, "end": 5864}, {"filename": "/resources/impulse_wars/shaders/gls100/grid.fs", "start": 5864, "end": 6805}, {"filename": "/resources/impulse_wars/shaders/gls100/grid.vs", "start": 6805, "end": 7554}, {"filename": "/resources/impulse_wars/shaders/gls330/bloom.fs", "start": 7554, "end": 9264}, {"filename": "/resources/impulse_wars/shaders/gls330/bloom.vs", "start": 9264, "end": 10013}, {"filename": "/resources/impulse_wars/shaders/gls330/blur.fs", "start": 10013, "end": 11821}, {"filename": "/resources/impulse_wars/shaders/gls330/blur.vs", "start": 11821, "end": 12570}, {"filename": "/resources/impulse_wars/shaders/gls330/grid.fs", "start": 12570, "end": 13511}, {"filename": "/resources/impulse_wars/shaders/gls330/grid.vs", "start": 13511, "end": 14260}, {"filename": "/resources/impulse_wars/wall_texture_map.png", "start": 14260, "end": 15114}, {"filename": "/resources/shared/puffer.glb", "start": 15114, "end": 1214738}, {"filename": "/resources/shared/puffers.png", "start": 1214738, "end": 1511876}, {"filename": "/resources/shared/puffers_128.png", "start": 1511876, "end": 1534782}], "remote_package_size": 1534782});

  })();

// end include: /tmp/tmpbzqpt2dv.js
// include: /tmp/tmpybxodt0u.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpybxodt0u.js
// include: /tmp/tmpu9axm99v.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpu9axm99v.js
...
var ASM_CONSTS = {
  45040: () => { if (document.fullscreenElement) return 1; },  
 45086: () => { return document.getElementById('canvas').width; },  
 45138: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45206: () => { document.exitFullscreen(); },  
 45233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 45306: () => { if (document.fullscreenElement) return 1; },  
 45352: () => { return document.getElementById('canvas').width; },  
 45404: () => { return screen.width; },  
 45429: () => { document.exitFullscreen(); },  
 45456: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 45589: () => { return window.innerWidth; },  
 45615: () => { return window.innerHeight; },  
 45642: () => { if (document.fullscreenElement) return 1; },  
 45688: () => { return document.getElementById('canvas').width; },  
 45740: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45808: () => { if (document.fullscreenElement) return 1; },  
 45854: () => { return document.getElementById('canvas').width; },  
 45906: () => { return screen.width; },  
 45931: () => { return window.innerWidth; },  
 45957: () => { return window.innerHeight; },  
 45984: () => { if (document.fullscreenElement) return 1; },  
 46030: () => { return document.getElementById('canvas').width; },  
 46082: () => { return screen.width; },  
 46107: () => { document.exitFullscreen(); },  
 46134: () => { if (document.fullscreenElement) return 1; },  
 46180: () => { return document.getElementById('canvas').width; },  
 46232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 46300: () => { document.exitFullscreen(); },  
 46327: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 46385: () => { return screen.width; },  
 46410: () => { return screen.height; },  
 46436: () => { return window.screenX; },  
 46463: () => { return window.screenY; },  
 46490: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 46543: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 46614: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 46671: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 46927: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 46998: () => { if (document.fullscreenElement) return 1; },  
 47044: () => { return window.innerWidth; },  
 47070: () => { return window.innerHeight; },  
 47097: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
...
var dynCall_fiiifi = Module['dynCall_fiiifi'] = createExportWrapper('dynCall_fiiifi', 6);
...
var dynCall_ffifi = Module['dynCall_ffifi'] = createExportWrapper('dynCall_ffifi', 5);
var dynCall_fiiji = Module['dynCall_fiiji'] = createExportWrapper('dynCall_fiiji', 5);
