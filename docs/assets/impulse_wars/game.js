...
Module['FS_createPath']("/resources", "shared", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/impulse_wars/create_texture.py", "start": 0, "end": 858}, {"filename": "/resources/impulse_wars/shaders/gls100/bloom.fs", "start": 858, "end": 2566}, {"filename": "/resources/impulse_wars/shaders/gls100/blur.fs", "start": 2566, "end": 4761}, {"filename": "/resources/impulse_wars/shaders/gls100/grid.fs", "start": 4761, "end": 5692}, {"filename": "/resources/impulse_wars/shaders/gls100/shader.vs", "start": 5692, "end": 6485}, {"filename": "/resources/impulse_wars/shaders/gls330/bloom.fs", "start": 6485, "end": 8195}, {"filename": "/resources/impulse_wars/shaders/gls330/blur.fs", "start": 8195, "end": 10003}, {"filename": "/resources/impulse_wars/shaders/gls330/grid.fs", "start": 10003, "end": 10944}, {"filename": "/resources/impulse_wars/shaders/gls330/shader.vs", "start": 10944, "end": 11693}, {"filename": "/resources/impulse_wars/shaders/gls330/shockwave.fs", "start": 11693, "end": 13403}, {"filename": "/resources/impulse_wars/wall_texture_map.png", "start": 13403, "end": 14257}, {"filename": "/resources/shared/puffer.glb", "start": 14257, "end": 1213881}, {"filename": "/resources/shared/puffers.png", "start": 1213881, "end": 1511019}, {"filename": "/resources/shared/puffers_128.png", "start": 1511019, "end": 1533925}], "remote_package_size": 1533925});

  })();

// end include: /tmp/tmpdn73cnf2.js
// include: /tmp/tmpuh5npo8f.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpuh5npo8f.js
// include: /tmp/tmpm4went32.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpm4went32.js
...
var ASM_CONSTS = {
  45024: () => { if (document.fullscreenElement) return 1; },  
 45070: () => { return document.getElementById('canvas').width; },  
 45122: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45190: () => { document.exitFullscreen(); },  
 45217: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 45290: () => { if (document.fullscreenElement) return 1; },  
 45336: () => { return document.getElementById('canvas').width; },  
 45388: () => { return screen.width; },  
 45413: () => { document.exitFullscreen(); },  
 45440: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 45573: () => { return window.innerWidth; },  
 45599: () => { return window.innerHeight; },  
 45626: () => { if (document.fullscreenElement) return 1; },  
 45672: () => { return document.getElementById('canvas').width; },  
 45724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45792: () => { if (document.fullscreenElement) return 1; },  
 45838: () => { return document.getElementById('canvas').width; },  
 45890: () => { return screen.width; },  
 45915: () => { return window.innerWidth; },  
 45941: () => { return window.innerHeight; },  
 45968: () => { if (document.fullscreenElement) return 1; },  
 46014: () => { return document.getElementById('canvas').width; },  
 46066: () => { return screen.width; },  
 46091: () => { document.exitFullscreen(); },  
 46118: () => { if (document.fullscreenElement) return 1; },  
 46164: () => { return document.getElementById('canvas').width; },  
 46216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 46284: () => { document.exitFullscreen(); },  
 46311: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 46369: () => { return screen.width; },  
 46394: () => { return screen.height; },  
 46420: () => { return window.screenX; },  
 46447: () => { return window.screenY; },  
 46474: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 46527: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 46598: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 46655: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 46911: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 46982: () => { if (document.fullscreenElement) return 1; },  
 47028: () => { return window.innerWidth; },  
 47054: () => { return window.innerHeight; },  
 47081: () => { if (document.pointerLockElement) return 1; }
};
...
var dynCall_fiiifi = makeInvalidEarlyAccess('dynCall_fiiifi');
...
var dynCall_ffifi = makeInvalidEarlyAccess('dynCall_ffifi');
var dynCall_fiiji = makeInvalidEarlyAccess('dynCall_fiiji');
...
function assignWasmExports(wasmExports) {
  ...
  dynCalls['fiiifi'] = dynCall_fiiifi = createExportWrapper('dynCall_fiiifi', 6);
  ...
  dynCalls['ffifi'] = dynCall_ffifi = createExportWrapper('dynCall_ffifi', 5);
  dynCalls['fiiji'] = dynCall_fiiji = createExportWrapper('dynCall_fiiji', 5);
