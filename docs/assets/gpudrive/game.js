...
// include: /tmp/tmpl1dx9yhm.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/gpudrive/game.data';
...
Module['FS_createPath']("/resources", "gpudrive", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/gpudrive/game.data');

      };
      Module['addRunDependency']('datafile_build_web/gpudrive/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/gpudrive/BlueCar.glb", "start": 0, "end": 239892}, {"filename": "/resources/gpudrive/GreenCar.glb", "start": 239892, "end": 479788}, {"filename": "/resources/gpudrive/GreyCar.glb", "start": 479788, "end": 719680}, {"filename": "/resources/gpudrive/RedCar.glb", "start": 719680, "end": 959556}, {"filename": "/resources/gpudrive/WhiteCar.glb", "start": 959556, "end": 1199448}, {"filename": "/resources/gpudrive/YellowCar.glb", "start": 1199448, "end": 1439324}, {"filename": "/resources/gpudrive/gpudrive_weights.bin", "start": 1439324, "end": 10290096}, {"filename": "/resources/gpudrive/map_942.bin", "start": 10290096, "end": 10594108}, {"filename": "/resources/shared/puffer.glb", "start": 10594108, "end": 11793732}, {"filename": "/resources/shared/puffers.png", "start": 11793732, "end": 12090870}, {"filename": "/resources/shared/puffers_128.png", "start": 12090870, "end": 12113776}], "remote_package_size": 12113776});

  })();

// end include: /tmp/tmpl1dx9yhm.js
// include: /tmp/tmppnwab6lv.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmppnwab6lv.js
// include: /tmp/tmpzb4hde4x.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpzb4hde4x.js
...
var ASM_CONSTS = {
  43192: () => { if (document.fullscreenElement) return 1; },  
 43238: () => { return document.getElementById('canvas').width; },  
 43290: () => { return parseInt(document.getElementById('canvas').style.width); },  
 43358: () => { document.exitFullscreen(); },  
 43385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 43458: () => { if (document.fullscreenElement) return 1; },  
 43504: () => { return document.getElementById('canvas').width; },  
 43556: () => { return screen.width; },  
 43581: () => { document.exitFullscreen(); },  
 43608: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 43741: () => { return window.innerWidth; },  
 43767: () => { return window.innerHeight; },  
 43794: () => { if (document.fullscreenElement) return 1; },  
 43840: () => { return document.getElementById('canvas').width; },  
 43892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 43960: () => { if (document.fullscreenElement) return 1; },  
 44006: () => { return document.getElementById('canvas').width; },  
 44058: () => { return screen.width; },  
 44083: () => { return window.innerWidth; },  
 44109: () => { return window.innerHeight; },  
 44136: () => { if (document.fullscreenElement) return 1; },  
 44182: () => { return document.getElementById('canvas').width; },  
 44234: () => { return screen.width; },  
 44259: () => { document.exitFullscreen(); },  
 44286: () => { if (document.fullscreenElement) return 1; },  
 44332: () => { return document.getElementById('canvas').width; },  
 44384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 44452: () => { document.exitFullscreen(); },  
 44479: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 44537: () => { return screen.width; },  
 44562: () => { return screen.height; },  
 44588: () => { return window.screenX; },  
 44615: () => { return window.screenY; },  
 44642: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 44695: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 44766: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 44823: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 45079: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 45150: () => { if (document.fullscreenElement) return 1; },  
 45196: () => { return window.innerWidth; },  
 45222: () => { return window.innerHeight; },  
 45249: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
