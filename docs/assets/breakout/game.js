...
// include: /tmp/tmpr0saasjh.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/breakout/game.data';
...
Module['FS_createPath']("/resources", "breakout", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/breakout/game.data');

      };
      Module['addRunDependency']('datafile_build_web/breakout/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/breakout/breakout_weights.bin", "start": 0, "end": 591376}, {"filename": "/resources/shared/puffers.png", "start": 591376, "end": 888514}, {"filename": "/resources/shared/puffers_128.png", "start": 888514, "end": 911420}], "remote_package_size": 911420});

  })();

// end include: /tmp/tmpr0saasjh.js
// include: /tmp/tmpg191txny.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpg191txny.js
// include: /tmp/tmpbouulz3r.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpbouulz3r.js
...
var ASM_CONSTS = {
 ...
 35325: () => { return window.innerWidth; },  
 35351: () => { return window.innerHeight; },  
 35378: () => { if (document.fullscreenElement) return 1; },  
 35424: () => { return document.getElementById('canvas').width; },  
 35476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35544: () => { if (document.fullscreenElement) return 1; },  
 35590: () => { return document.getElementById('canvas').width; },  
 35642: () => { return screen.width; },  
 35667: () => { return window.innerWidth; },  
 35693: () => { return window.innerHeight; },  
 35720: () => { if (document.fullscreenElement) return 1; },  
 35766: () => { return document.getElementById('canvas').width; },  
 35818: () => { return screen.width; },  
 35843: () => { document.exitFullscreen(); },  
 35870: () => { if (document.fullscreenElement) return 1; },  
 35916: () => { return document.getElementById('canvas').width; },  
 35968: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36036: () => { document.exitFullscreen(); },  
 36063: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 36121: () => { return screen.width; },  
 36146: () => { return screen.height; },  
 36172: () => { return window.screenX; },  
 36199: () => { return window.screenY; },  
 36226: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 36279: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 36350: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 36407: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36663: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 36734: () => { if (document.fullscreenElement) return 1; },  
 36780: () => { return window.innerWidth; },  
 36806: () => { return window.innerHeight; },  
 36833: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
