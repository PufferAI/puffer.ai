...
// include: /tmp/tmp4tpwmq_k.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/boxoban/game.data';
...
Module['FS_createPath']("/resources", "boxoban", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/web/boxoban/game.data');

      };
      Module['addRunDependency']('datafile_build/web/boxoban/game.data');
    ...
    loadPackage({"files": [{"filename": "/config/boxoban.ini", "start": 0, "end": 655}, {"filename": "/config/boxoban_web.ini", "start": 655, "end": 975}, {"filename": "/config/default.ini", "start": 975, "end": 5506}, {"filename": "/resources/boxoban/Crate_Black.jpg", "start": 5506, "end": 180551}, {"filename": "/resources/boxoban/EndPoint_Black.jpg", "start": 180551, "end": 258070}, {"filename": "/resources/boxoban/EndPoint_Blue.jpg", "start": 258070, "end": 341474}, {"filename": "/resources/boxoban/GroundGravel_Concrete.jpg", "start": 341474, "end": 576218}, {"filename": "/resources/boxoban/Wall_Black.jpg", "start": 576218, "end": 740691}, {"filename": "/resources/boxoban/boxoban_weights.bin", "start": 740691, "end": 4302163}, {"filename": "/resources/boxoban/web_maps.bin", "start": 4302163, "end": 4308643}, {"filename": "/resources/shared/JetBrainsMono-Bold.ttf", "start": 4308643, "end": 4423471}, {"filename": "/resources/shared/JetBrainsMono-Medium.ttf", "start": 4423471, "end": 4538391}, {"filename": "/resources/shared/JetBrainsMono-Regular.ttf", "start": 4538391, "end": 4653295}, {"filename": "/resources/shared/JetBrainsMono-SemiBold.ttf", "start": 4653295, "end": 4768195}, {"filename": "/resources/shared/Montserrat-Regular.ttf", "start": 4768195, "end": 5099143}, {"filename": "/resources/shared/Roboto-Italic.ttf", "start": 5099143, "end": 5251351}, {"filename": "/resources/shared/Roboto-Regular.ttf", "start": 5251351, "end": 5397355}, {"filename": "/resources/shared/puffer.glb", "start": 5397355, "end": 6596979}, {"filename": "/resources/shared/puffers.png", "start": 6596979, "end": 6894117}, {"filename": "/resources/shared/puffers_128.png", "start": 6894117, "end": 6917023}], "remote_package_size": 6917023});

  })();

// end include: /tmp/tmp4tpwmq_k.js
// include: /tmp/tmpxvl1tkrm.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpxvl1tkrm.js
// include: /tmp/tmpihu84dk_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpihu84dk_.js
...
var ASM_CONSTS = {
  36136: () => { if (document.fullscreenElement) return 1; },  
 36182: () => { return document.getElementById('canvas').width; },  
 36234: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36302: () => { document.exitFullscreen(); },  
 36329: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 36402: () => { if (document.fullscreenElement) return 1; },  
 36448: () => { return document.getElementById('canvas').width; },  
 36500: () => { return screen.width; },  
 36525: () => { document.exitFullscreen(); },  
 36552: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36685: () => { return window.innerWidth; },  
 36711: () => { return window.innerHeight; },  
 36738: () => { if (document.fullscreenElement) return 1; },  
 36784: () => { return document.getElementById('canvas').width; },  
 36836: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36904: () => { if (document.fullscreenElement) return 1; },  
 36950: () => { return document.getElementById('canvas').width; },  
 37002: () => { return screen.width; },  
 37027: () => { return window.innerWidth; },  
 37053: () => { return window.innerHeight; },  
 37080: () => { if (document.fullscreenElement) return 1; },  
 37126: () => { return document.getElementById('canvas').width; },  
 37178: () => { return screen.width; },  
 37203: () => { document.exitFullscreen(); },  
 37230: () => { if (document.fullscreenElement) return 1; },  
 37276: () => { return document.getElementById('canvas').width; },  
 37328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37396: () => { document.exitFullscreen(); },  
 37423: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 37481: () => { return screen.width; },  
 37506: () => { return screen.height; },  
 37532: () => { return window.screenX; },  
 37559: () => { return window.screenY; },  
 37586: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37639: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 37710: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 37767: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 38023: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 38094: () => { if (document.fullscreenElement) return 1; },  
 38140: () => { return window.innerWidth; },  
 38166: () => { return window.innerHeight; },  
 38193: () => { if (document.pointerLockElement) return 1; }
};
