...
// include: /tmp/tmp7f8r3p5a.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/cpr/game.data';
...
Module['FS_createPath']("/resources", "cpr", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/cpr/game.data');

      };
      Module['addRunDependency']('datafile_build_web/cpr/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/cpr/cpr_weights.bin", "start": 0, "end": 557080}, {"filename": "/resources/cpr/inflated_puff.png", "start": 557080, "end": 603513}, {"filename": "/resources/cpr/puffers_128.png", "start": 603513, "end": 626419}, {"filename": "/resources/shared/puffer.glb", "start": 626419, "end": 1826043}, {"filename": "/resources/shared/puffers.png", "start": 1826043, "end": 2123181}, {"filename": "/resources/shared/puffers_128.png", "start": 2123181, "end": 2146087}], "remote_package_size": 2146087});

  })();

// end include: /tmp/tmp7f8r3p5a.js
// include: /tmp/tmpi5by9umg.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpi5by9umg.js
// include: /tmp/tmpjzg1p35z.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpjzg1p35z.js
...
var ASM_CONSTS = {
  35592: () => { if (document.fullscreenElement) return 1; },  
 35638: () => { return document.getElementById('canvas').width; },  
 35690: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35758: () => { document.exitFullscreen(); },  
 35785: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 35858: () => { if (document.fullscreenElement) return 1; },  
 35904: () => { return document.getElementById('canvas').width; },  
 35956: () => { return screen.width; },  
 35981: () => { document.exitFullscreen(); },  
 36008: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36141: () => { return window.innerWidth; },  
 36167: () => { return window.innerHeight; },  
 36194: () => { if (document.fullscreenElement) return 1; },  
 36240: () => { return document.getElementById('canvas').width; },  
 36292: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36360: () => { if (document.fullscreenElement) return 1; },  
 36406: () => { return document.getElementById('canvas').width; },  
 36458: () => { return screen.width; },  
 36483: () => { return window.innerWidth; },  
 36509: () => { return window.innerHeight; },  
 36536: () => { if (document.fullscreenElement) return 1; },  
 36582: () => { return document.getElementById('canvas').width; },  
 36634: () => { return screen.width; },  
 36659: () => { document.exitFullscreen(); },  
 36686: () => { if (document.fullscreenElement) return 1; },  
 36732: () => { return document.getElementById('canvas').width; },  
 36784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36852: () => { document.exitFullscreen(); },  
 36879: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 36937: () => { return screen.width; },  
 36962: () => { return screen.height; },  
 36988: () => { return window.screenX; },  
 37015: () => { return window.screenY; },  
 37042: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37095: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 37166: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 37223: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 37479: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 37550: () => { if (document.fullscreenElement) return 1; },  
 37596: () => { return window.innerWidth; },  
 37622: () => { return window.innerHeight; },  
 37649: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
