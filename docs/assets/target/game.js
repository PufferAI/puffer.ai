...
// include: /tmp/tmpefvyfxsz.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/target/game.data';
...
Module['FS_createPath']("/resources", "target", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/target/game.data');

      };
      Module['addRunDependency']('datafile_build_web/target/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffers.png", "start": 0, "end": 297138}, {"filename": "/resources/shared/puffers_128.png", "start": 297138, "end": 320044}, {"filename": "/resources/target/star.png", "start": 320044, "end": 325728}, {"filename": "/resources/target/target_weights.bin", "start": 325728, "end": 876700}], "remote_package_size": 876700});

  })();

// end include: /tmp/tmpefvyfxsz.js
// include: /tmp/tmpog6wyveb.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpog6wyveb.js
// include: /tmp/tmpysgcfhly.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpysgcfhly.js
...
var ASM_CONSTS = {
  34488: () => { if (document.fullscreenElement) return 1; },  
 34534: () => { return document.getElementById('canvas').width; },  
 34586: () => { return parseInt(document.getElementById('canvas').style.width); },  
 34654: () => { document.exitFullscreen(); },  
 34681: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 34754: () => { if (document.fullscreenElement) return 1; },  
 34800: () => { return document.getElementById('canvas').width; },  
 34852: () => { return screen.width; },  
 34877: () => { document.exitFullscreen(); },  
 34904: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35037: () => { return window.innerWidth; },  
 35063: () => { return window.innerHeight; },  
 35090: () => { if (document.fullscreenElement) return 1; },  
 35136: () => { return document.getElementById('canvas').width; },  
 35188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35256: () => { if (document.fullscreenElement) return 1; },  
 35302: () => { return document.getElementById('canvas').width; },  
 35354: () => { return screen.width; },  
 35379: () => { return window.innerWidth; },  
 35405: () => { return window.innerHeight; },  
 35432: () => { if (document.fullscreenElement) return 1; },  
 35478: () => { return document.getElementById('canvas').width; },  
 35530: () => { return screen.width; },  
 35555: () => { document.exitFullscreen(); },  
 35582: () => { if (document.fullscreenElement) return 1; },  
 35628: () => { return document.getElementById('canvas').width; },  
 35680: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35748: () => { document.exitFullscreen(); },  
 35775: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 35833: () => { return screen.width; },  
 35858: () => { return screen.height; },  
 35884: () => { return window.screenX; },  
 35911: () => { return window.screenY; },  
 35938: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 35991: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 36062: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 36119: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36375: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 36446: () => { if (document.fullscreenElement) return 1; },  
 36492: () => { return window.innerWidth; },  
 36518: () => { return window.innerHeight; },  
 36545: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
