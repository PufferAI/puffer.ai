...
// include: /tmp/tmpd_1guuv2.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/tower_climb/game.data';
...
Module['FS_createPath']("/resources", "tower_climb", true, true);
Module['FS_createPath']("/resources/tower_climb", "shaders", true, true);
Module['FS_createPath']("/resources/tower_climb/shaders", "gls100", true, true);
Module['FS_createPath']("/resources/tower_climb/shaders", "gls330", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/tower_climb/game.data');

      };
      Module['addRunDependency']('datafile_build_web/tower_climb/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffer.glb", "start": 0, "end": 1199624}, {"filename": "/resources/shared/puffers.png", "start": 1199624, "end": 1496762}, {"filename": "/resources/shared/puffers_128.png", "start": 1496762, "end": 1519668}, {"filename": "/resources/tower_climb/shaders/gls100/lighting.fs", "start": 1519668, "end": 1521623}, {"filename": "/resources/tower_climb/shaders/gls100/lighting.vs", "start": 1521623, "end": 1523200}, {"filename": "/resources/tower_climb/shaders/gls330/lighting.fs", "start": 1523200, "end": 1525152}, {"filename": "/resources/tower_climb/shaders/gls330/lighting.vs", "start": 1525152, "end": 1525900}, {"filename": "/resources/tower_climb/small_astro.glb", "start": 1525900, "end": 9024772}, {"filename": "/resources/tower_climb/space2.jpg", "start": 9024772, "end": 12007152}, {"filename": "/resources/tower_climb/spacerock.glb", "start": 12007152, "end": 14102512}, {"filename": "/resources/tower_climb/tower_climb_weights.bin", "start": 14102512, "end": 16344140}], "remote_package_size": 16344140});

  })();

// end include: /tmp/tmpd_1guuv2.js
// include: /tmp/tmpdtwxqeac.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpdtwxqeac.js
// include: /tmp/tmpxbc6sy5d.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpxbc6sy5d.js
...
var ASM_CONSTS = {
  44312: () => { if (document.fullscreenElement) return 1; },  
 44358: () => { return document.getElementById('canvas').width; },  
 44410: () => { return parseInt(document.getElementById('canvas').style.width); },  
 44478: () => { document.exitFullscreen(); },  
 44505: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 44578: () => { if (document.fullscreenElement) return 1; },  
 44624: () => { return document.getElementById('canvas').width; },  
 44676: () => { return screen.width; },  
 44701: () => { document.exitFullscreen(); },  
 44728: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 44861: () => { return window.innerWidth; },  
 44887: () => { return window.innerHeight; },  
 44914: () => { if (document.fullscreenElement) return 1; },  
 44960: () => { return document.getElementById('canvas').width; },  
 45012: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45080: () => { if (document.fullscreenElement) return 1; },  
 45126: () => { return document.getElementById('canvas').width; },  
 45178: () => { return screen.width; },  
 45203: () => { return window.innerWidth; },  
 45229: () => { return window.innerHeight; },  
 45256: () => { if (document.fullscreenElement) return 1; },  
 45302: () => { return document.getElementById('canvas').width; },  
 45354: () => { return screen.width; },  
 45379: () => { document.exitFullscreen(); },  
 45406: () => { if (document.fullscreenElement) return 1; },  
 45452: () => { return document.getElementById('canvas').width; },  
 45504: () => { return parseInt(document.getElementById('canvas').style.width); },  
 45572: () => { document.exitFullscreen(); },  
 45599: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 45657: () => { return screen.width; },  
 45682: () => { return screen.height; },  
 45708: () => { return window.screenX; },  
 45735: () => { return window.screenY; },  
 45762: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 45815: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 45886: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 45943: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 46199: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 46270: () => { if (document.fullscreenElement) return 1; },  
 46316: () => { return window.innerWidth; },  
 46342: () => { return window.innerHeight; },  
 46369: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
