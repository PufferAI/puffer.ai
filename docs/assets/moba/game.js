...
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/moba/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/moba/bloom_shader_100.fs", "start": 0, "end": 1069}, {"filename": "/resources/moba/bloom_shader_330.fs", "start": 1069, "end": 2140}, {"filename": "/resources/moba/dota_map.png", "start": 2140, "end": 5836}, {"filename": "/resources/moba/game_map.npy", "start": 5836, "end": 22220}, {"filename": "/resources/moba/map_shader_100.fs", "start": 22220, "end": 25800}, {"filename": "/resources/moba/map_shader_330.fs", "start": 25800, "end": 32377}, {"filename": "/resources/moba/moba_assets.png", "start": 32377, "end": 145626}, {"filename": "/resources/moba/moba_weights.bin", "start": 145626, "end": 1665850}, {"filename": "/resources/shared/puffer.glb", "start": 1665850, "end": 2865474}, {"filename": "/resources/shared/puffers.png", "start": 2865474, "end": 3162612}, {"filename": "/resources/shared/puffers_128.png", "start": 3162612, "end": 3185518}], "remote_package_size": 3185518});

  })();

// end include: /tmp/tmp3omn6jqb.js
// include: /tmp/tmp1mftsg3z.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp1mftsg3z.js
// include: /tmp/tmp35z7ef27.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp35z7ef27.js
...
var ASM_CONSTS = {
  37400: () => { if (document.fullscreenElement) return 1; },  
 37446: () => { return document.getElementById('canvas').width; },  
 37498: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37566: () => { document.exitFullscreen(); },  
 37593: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 37666: () => { if (document.fullscreenElement) return 1; },  
 37712: () => { return document.getElementById('canvas').width; },  
 37764: () => { return screen.width; },  
 37789: () => { document.exitFullscreen(); },  
 37816: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 37949: () => { return window.innerWidth; },  
 37975: () => { return window.innerHeight; },  
 38002: () => { if (document.fullscreenElement) return 1; },  
 38048: () => { return document.getElementById('canvas').width; },  
 38100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 38168: () => { if (document.fullscreenElement) return 1; },  
 38214: () => { return document.getElementById('canvas').width; },  
 38266: () => { return screen.width; },  
 38291: () => { return window.innerWidth; },  
 38317: () => { return window.innerHeight; },  
 38344: () => { if (document.fullscreenElement) return 1; },  
 38390: () => { return document.getElementById('canvas').width; },  
 38442: () => { return screen.width; },  
 38467: () => { document.exitFullscreen(); },  
 38494: () => { if (document.fullscreenElement) return 1; },  
 38540: () => { return document.getElementById('canvas').width; },  
 38592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 38660: () => { document.exitFullscreen(); },  
 38687: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 38745: () => { return screen.width; },  
 38770: () => { return screen.height; },  
 38796: () => { return window.screenX; },  
 38823: () => { return window.screenY; },  
 38850: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 38903: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 38974: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 39031: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 39287: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 39358: () => { if (document.fullscreenElement) return 1; },  
 39404: () => { return window.innerWidth; },  
 39430: () => { return window.innerHeight; },  
 39457: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
