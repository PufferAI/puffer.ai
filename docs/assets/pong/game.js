...
// include: /tmp/tmpdybtrc5q.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/pong/game.data';
...
Module['FS_createPath']("/resources", "pong", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/pong/game.data');

      };
      Module['addRunDependency']('datafile_build_web/pong/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/pong/pong_weights.bin", "start": 0, "end": 535056}, {"filename": "/resources/shared/puffers.png", "start": 535056, "end": 832194}, {"filename": "/resources/shared/puffers_128.png", "start": 832194, "end": 855100}], "remote_package_size": 855100});

  })();

// end include: /tmp/tmpdybtrc5q.js
// include: /tmp/tmpzli2_1xh.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpzli2_1xh.js
// include: /tmp/tmp0rskguqx.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp0rskguqx.js
...
var ASM_CONSTS = {
  34632: () => { if (document.fullscreenElement) return 1; },  
 34678: () => { return document.getElementById('canvas').width; },  
 34730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 34798: () => { document.exitFullscreen(); },  
 34825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 34898: () => { if (document.fullscreenElement) return 1; },  
 34944: () => { return document.getElementById('canvas').width; },  
 34996: () => { return screen.width; },  
 35021: () => { document.exitFullscreen(); },  
 35048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 35181: () => { return window.innerWidth; },  
 35207: () => { return window.innerHeight; },  
 35234: () => { if (document.fullscreenElement) return 1; },  
 35280: () => { return document.getElementById('canvas').width; },  
 35332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35400: () => { if (document.fullscreenElement) return 1; },  
 35446: () => { return document.getElementById('canvas').width; },  
 35498: () => { return screen.width; },  
 35523: () => { return window.innerWidth; },  
 35549: () => { return window.innerHeight; },  
 35576: () => { if (document.fullscreenElement) return 1; },  
 35622: () => { return document.getElementById('canvas').width; },  
 35674: () => { return screen.width; },  
 35699: () => { document.exitFullscreen(); },  
 35726: () => { if (document.fullscreenElement) return 1; },  
 35772: () => { return document.getElementById('canvas').width; },  
 35824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35892: () => { document.exitFullscreen(); },  
 35919: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 35977: () => { return screen.width; },  
 36002: () => { return screen.height; },  
 36028: () => { return window.screenX; },  
 36055: () => { return window.screenY; },  
 36082: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 36135: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 36206: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 36263: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36519: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 36590: () => { if (document.fullscreenElement) return 1; },  
 36636: () => { return window.innerWidth; },  
 36662: () => { return window.innerHeight; },  
 36689: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
