...
// include: /tmp/tmpf7bjrq_k.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/whisker_racer/game.data';
...
Module['FS_createPath']("/resources", "whisker_racer", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/whisker_racer/game.data');

      };
      Module['addRunDependency']('datafile_build_web/whisker_racer/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffer.glb", "start": 0, "end": 1199624}, {"filename": "/resources/shared/puffers.png", "start": 1199624, "end": 1496762}, {"filename": "/resources/shared/puffers_128.png", "start": 1496762, "end": 1519668}, {"filename": "/resources/whisker_racer/puffer_whisker_racer_weights.bin", "start": 1519668, "end": 2052164}], "remote_package_size": 2052164});

  })();

// end include: /tmp/tmpf7bjrq_k.js
// include: /tmp/tmp440dciy_.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp440dciy_.js
// include: /tmp/tmpwhgdkvlh.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpwhgdkvlh.js
...
var ASM_CONSTS = {
  49000: () => { if (document.fullscreenElement) return 1; },  
 49046: () => { return document.getElementById('canvas').width; },  
 49098: () => { return parseInt(document.getElementById('canvas').style.width); },  
 49166: () => { document.exitFullscreen(); },  
 49193: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 49266: () => { if (document.fullscreenElement) return 1; },  
 49312: () => { return document.getElementById('canvas').width; },  
 49364: () => { return screen.width; },  
 49389: () => { document.exitFullscreen(); },  
 49416: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 49549: () => { return window.innerWidth; },  
 49575: () => { return window.innerHeight; },  
 49602: () => { if (document.fullscreenElement) return 1; },  
 49648: () => { return document.getElementById('canvas').width; },  
 49700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 49768: () => { if (document.fullscreenElement) return 1; },  
 49814: () => { return document.getElementById('canvas').width; },  
 49866: () => { return screen.width; },  
 49891: () => { return window.innerWidth; },  
 49917: () => { return window.innerHeight; },  
 49944: () => { if (document.fullscreenElement) return 1; },  
 49990: () => { return document.getElementById('canvas').width; },  
 50042: () => { return screen.width; },  
 50067: () => { document.exitFullscreen(); },  
 50094: () => { if (document.fullscreenElement) return 1; },  
 50140: () => { return document.getElementById('canvas').width; },  
 50192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 50260: () => { document.exitFullscreen(); },  
 50287: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 50345: () => { return screen.width; },  
 50370: () => { return screen.height; },  
 50396: () => { return window.screenX; },  
 50423: () => { return window.screenY; },  
 50450: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 50503: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 50574: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 50631: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 50887: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 50958: () => { if (document.fullscreenElement) return 1; },  
 51004: () => { return window.innerWidth; },  
 51030: () => { return window.innerHeight; },  
 51057: () => { if (document.pointerLockElement) return 1; }
};
