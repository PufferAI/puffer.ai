...
Module['FS_createPath']("/resources", "trash_pickup", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffers.png", "start": 0, "end": 297138}, {"filename": "/resources/shared/puffers_128.png", "start": 297138, "end": 320044}, {"filename": "/resources/trash_pickup/trash_pickup_weights.bin", "start": 320044, "end": 921024}], "remote_package_size": 921024});

  })();

// end include: /tmp/tmp4bdq_r5y.js
// include: /tmp/tmps8rv46fv.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmps8rv46fv.js
// include: /tmp/tmptoyydvgn.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmptoyydvgn.js
...
var ASM_CONSTS = {
  34424: () => { if (document.fullscreenElement) return 1; },  
 34470: () => { return document.getElementById('canvas').width; },  
 34522: () => { return parseInt(document.getElementById('canvas').style.width); },  
 34590: () => { document.exitFullscreen(); },  
 34617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 34690: () => { if (document.fullscreenElement) return 1; },  
 34736: () => { return document.getElementById('canvas').width; },  
 34788: () => { return screen.width; },  
 34813: () => { document.exitFullscreen(); },  
 34840: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 34973: () => { return window.innerWidth; },  
 34999: () => { return window.innerHeight; },  
 35026: () => { if (document.fullscreenElement) return 1; },  
 35072: () => { return document.getElementById('canvas').width; },  
 35124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35192: () => { if (document.fullscreenElement) return 1; },  
 35238: () => { return document.getElementById('canvas').width; },  
 35290: () => { return screen.width; },  
 35315: () => { return window.innerWidth; },  
 35341: () => { return window.innerHeight; },  
 35368: () => { if (document.fullscreenElement) return 1; },  
 35414: () => { return document.getElementById('canvas').width; },  
 35466: () => { return screen.width; },  
 35491: () => { document.exitFullscreen(); },  
 35518: () => { if (document.fullscreenElement) return 1; },  
 35564: () => { return document.getElementById('canvas').width; },  
 35616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 35684: () => { document.exitFullscreen(); },  
 35711: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 35769: () => { return screen.width; },  
 35794: () => { return screen.height; },  
 35820: () => { return window.screenX; },  
 35847: () => { return window.screenY; },  
 35874: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 35927: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 35998: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 36055: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 36311: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 36382: () => { if (document.fullscreenElement) return 1; },  
 36428: () => { return window.innerWidth; },  
 36454: () => { return window.innerHeight; },  
 36481: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
