...
// include: /tmp/tmpswssud44.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/connect4/game.data';
...
Module['FS_createPath']("/resources", "connect4", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/connect4/game.data');

      };
      Module['addRunDependency']('datafile_build_web/connect4/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/connect4/connect4_weights.bin", "start": 0, "end": 554528}, {"filename": "/resources/shared/puffers.png", "start": 554528, "end": 851666}, {"filename": "/resources/shared/puffers_128.png", "start": 851666, "end": 874572}], "remote_package_size": 874572});

  })();

// end include: /tmp/tmpswssud44.js
// include: /tmp/tmpz2h8gx6t.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpz2h8gx6t.js
// include: /tmp/tmpr3kmjdye.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpr3kmjdye.js
...
var ASM_CONSTS = {
  40808: () => { if (document.fullscreenElement) return 1; },  
 40854: () => { return document.getElementById('canvas').width; },  
 40906: () => { return parseInt(document.getElementById('canvas').style.width); },  
 40974: () => { document.exitFullscreen(); },  
 41001: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 41074: () => { if (document.fullscreenElement) return 1; },  
 41120: () => { return document.getElementById('canvas').width; },  
 41172: () => { return screen.width; },  
 41197: () => { document.exitFullscreen(); },  
 41224: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 41357: () => { return window.innerWidth; },  
 41383: () => { return window.innerHeight; },  
 41410: () => { if (document.fullscreenElement) return 1; },  
 41456: () => { return document.getElementById('canvas').width; },  
 41508: () => { return parseInt(document.getElementById('canvas').style.width); },  
 41576: () => { if (document.fullscreenElement) return 1; },  
 41622: () => { return document.getElementById('canvas').width; },  
 41674: () => { return screen.width; },  
 41699: () => { return window.innerWidth; },  
 41725: () => { return window.innerHeight; },  
 41752: () => { if (document.fullscreenElement) return 1; },  
 41798: () => { return document.getElementById('canvas').width; },  
 41850: () => { return screen.width; },  
 41875: () => { document.exitFullscreen(); },  
 41902: () => { if (document.fullscreenElement) return 1; },  
 41948: () => { return document.getElementById('canvas').width; },  
 42000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 42068: () => { document.exitFullscreen(); },  
 42095: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 42153: () => { return screen.width; },  
 42178: () => { return screen.height; },  
 42204: () => { return window.screenX; },  
 42231: () => { return window.screenY; },  
 42258: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 42311: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 42382: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 42439: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 42695: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 42766: () => { if (document.fullscreenElement) return 1; },  
 42812: () => { return window.innerWidth; },  
 42838: () => { return window.innerHeight; },  
 42865: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
