...
// include: /tmp/tmpp__e0zms.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/pacman/game.data';
...
Module['FS_createPath']("/resources", "pacman", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/pacman/game.data');

      };
      Module['addRunDependency']('datafile_build_web/pacman/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/pacman/blinky_down.png", "start": 0, "end": 186}, {"filename": "/resources/pacman/blinky_left.png", "start": 186, "end": 374}, {"filename": "/resources/pacman/blinky_right.png", "start": 374, "end": 564}, {"filename": "/resources/pacman/blinky_up.png", "start": 564, "end": 751}, {"filename": "/resources/pacman/clyde_down.png", "start": 751, "end": 948}, {"filename": "/resources/pacman/clyde_left.png", "start": 948, "end": 1152}, {"filename": "/resources/pacman/clyde_right.png", "start": 1152, "end": 1355}, {"filename": "/resources/pacman/clyde_up.png", "start": 1355, "end": 1550}, {"filename": "/resources/pacman/eyes_down.png", "start": 1550, "end": 1688}, {"filename": "/resources/pacman/eyes_left.png", "start": 1688, "end": 1820}, {"filename": "/resources/pacman/eyes_right.png", "start": 1820, "end": 1945}, {"filename": "/resources/pacman/eyes_up.png", "start": 1945, "end": 2080}, {"filename": "/resources/pacman/inky_down.png", "start": 2080, "end": 2268}, {"filename": "/resources/pacman/inky_left.png", "start": 2268, "end": 2460}, {"filename": "/resources/pacman/inky_right.png", "start": 2460, "end": 2653}, {"filename": "/resources/pacman/inky_up.png", "start": 2653, "end": 2836}, {"filename": "/resources/pacman/pacman_weights.bin", "start": 2836, "end": 683304}, {"filename": "/resources/pacman/pinky_down.png", "start": 683304, "end": 683494}, {"filename": "/resources/pacman/pinky_left.png", "start": 683494, "end": 683692}, {"filename": "/resources/pacman/pinky_right.png", "start": 683692, "end": 683890}, {"filename": "/resources/pacman/pinky_up.png", "start": 683890, "end": 684080}, {"filename": "/resources/pacman/scared.png", "start": 684080, "end": 684271}, {"filename": "/resources/pacman/tileset.png", "start": 684271, "end": 687527}, {"filename": "/resources/shared/puffer.glb", "start": 687527, "end": 1887151}, {"filename": "/resources/shared/puffers.png", "start": 1887151, "end": 2184289}, {"filename": "/resources/shared/puffers_128.png", "start": 2184289, "end": 2207195}], "remote_package_size": 2207195});

  })();

// end include: /tmp/tmpp__e0zms.js
// include: /tmp/tmp2arobcis.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp2arobcis.js
// include: /tmp/tmpu1wxsk74.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpu1wxsk74.js
...
var ASM_CONSTS = {
  36072: () => { if (document.fullscreenElement) return 1; },  
 36118: () => { return document.getElementById('canvas').width; },  
 36170: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36238: () => { document.exitFullscreen(); },  
 36265: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 36338: () => { if (document.fullscreenElement) return 1; },  
 36384: () => { return document.getElementById('canvas').width; },  
 36436: () => { return screen.width; },  
 36461: () => { document.exitFullscreen(); },  
 36488: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 36621: () => { return window.innerWidth; },  
 36647: () => { return window.innerHeight; },  
 36674: () => { if (document.fullscreenElement) return 1; },  
 36720: () => { return document.getElementById('canvas').width; },  
 36772: () => { return parseInt(document.getElementById('canvas').style.width); },  
 36840: () => { if (document.fullscreenElement) return 1; },  
 36886: () => { return document.getElementById('canvas').width; },  
 36938: () => { return screen.width; },  
 36963: () => { return window.innerWidth; },  
 36989: () => { return window.innerHeight; },  
 37016: () => { if (document.fullscreenElement) return 1; },  
 37062: () => { return document.getElementById('canvas').width; },  
 37114: () => { return screen.width; },  
 37139: () => { document.exitFullscreen(); },  
 37166: () => { if (document.fullscreenElement) return 1; },  
 37212: () => { return document.getElementById('canvas').width; },  
 37264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37332: () => { document.exitFullscreen(); },  
 37359: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 37417: () => { return screen.width; },  
 37442: () => { return screen.height; },  
 37468: () => { return window.screenX; },  
 37495: () => { return window.screenY; },  
 37522: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 37575: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 37646: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 37703: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 37959: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 38030: () => { if (document.fullscreenElement) return 1; },  
 38076: () => { return window.innerWidth; },  
 38102: () => { return window.innerHeight; },  
 38129: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
