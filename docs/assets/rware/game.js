...
// include: /tmp/tmpqx5civ5t.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/rware/game.data';
...
Module['FS_createPath']("/resources", "rware", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/rware/game.data');

      };
      Module['addRunDependency']('datafile_build_web/rware/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/rware/rware_weights.bin", "start": 0, "end": 545816}, {"filename": "/resources/shared/puffers.png", "start": 545816, "end": 842954}, {"filename": "/resources/shared/puffers_128.png", "start": 842954, "end": 865860}], "remote_package_size": 865860});

  })();

// end include: /tmp/tmpqx5civ5t.js
// include: /tmp/tmpluhtqh17.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpluhtqh17.js
// include: /tmp/tmpmv4a880i.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpmv4a880i.js
...
var ASM_CONSTS = {
  37976: () => { if (document.fullscreenElement) return 1; },  
 38022: () => { return document.getElementById('canvas').width; },  
 38074: () => { return parseInt(document.getElementById('canvas').style.width); },  
 38142: () => { document.exitFullscreen(); },  
 38169: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 38242: () => { if (document.fullscreenElement) return 1; },  
 38288: () => { return document.getElementById('canvas').width; },  
 38340: () => { return screen.width; },  
 38365: () => { document.exitFullscreen(); },  
 38392: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 38525: () => { return window.innerWidth; },  
 38551: () => { return window.innerHeight; },  
 38578: () => { if (document.fullscreenElement) return 1; },  
 38624: () => { return document.getElementById('canvas').width; },  
 38676: () => { return parseInt(document.getElementById('canvas').style.width); },  
 38744: () => { if (document.fullscreenElement) return 1; },  
 38790: () => { return document.getElementById('canvas').width; },  
 38842: () => { return screen.width; },  
 38867: () => { return window.innerWidth; },  
 38893: () => { return window.innerHeight; },  
 38920: () => { if (document.fullscreenElement) return 1; },  
 38966: () => { return document.getElementById('canvas').width; },  
 39018: () => { return screen.width; },  
 39043: () => { document.exitFullscreen(); },  
 39070: () => { if (document.fullscreenElement) return 1; },  
 39116: () => { return document.getElementById('canvas').width; },  
 39168: () => { return parseInt(document.getElementById('canvas').style.width); },  
 39236: () => { document.exitFullscreen(); },  
 39263: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 39321: () => { return screen.width; },  
 39346: () => { return screen.height; },  
 39372: () => { return window.screenX; },  
 39399: () => { return window.screenY; },  
 39426: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 39479: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 39550: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 39607: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 39863: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 39934: () => { if (document.fullscreenElement) return 1; },  
 39980: () => { return window.innerWidth; },  
 40006: () => { return window.innerHeight; },  
 40033: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
