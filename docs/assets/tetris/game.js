...
// include: /tmp/tmpn41dua8j.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/tetris/game.data';
...
Module['FS_createPath']("/resources", "tetris", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/tetris/game.data');

      };
      Module['addRunDependency']('datafile_build_web/tetris/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffers.png", "start": 0, "end": 297138}, {"filename": "/resources/shared/puffers_128.png", "start": 297138, "end": 320044}, {"filename": "/resources/tetris/tetris_weights.bin", "start": 320044, "end": 972876}], "remote_package_size": 972876});

  })();

// end include: /tmp/tmpn41dua8j.js
// include: /tmp/tmp62hqewum.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp62hqewum.js
// include: /tmp/tmp1sigo5y9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp1sigo5y9.js
...
var ASM_CONSTS = {
  32704: () => { if (document.fullscreenElement) return 1; },  
 32750: () => { return document.getElementById('canvas').width; },  
 32802: () => { return parseInt(document.getElementById('canvas').style.width); },  
 32870: () => { document.exitFullscreen(); },  
 32897: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 32970: () => { if (document.fullscreenElement) return 1; },  
 33016: () => { return document.getElementById('canvas').width; },  
 33068: () => { return screen.width; },  
 33093: () => { document.exitFullscreen(); },  
 33120: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 33253: () => { return window.innerWidth; },  
 33279: () => { return window.innerHeight; },  
 33306: () => { if (document.fullscreenElement) return 1; },  
 33352: () => { return document.getElementById('canvas').width; },  
 33404: () => { return parseInt(document.getElementById('canvas').style.width); },  
 33472: () => { if (document.fullscreenElement) return 1; },  
 33518: () => { return document.getElementById('canvas').width; },  
 33570: () => { return screen.width; },  
 33595: () => { return window.innerWidth; },  
 33621: () => { return window.innerHeight; },  
 33648: () => { if (document.fullscreenElement) return 1; },  
 33694: () => { return document.getElementById('canvas').width; },  
 33746: () => { return screen.width; },  
 33771: () => { document.exitFullscreen(); },  
 33798: () => { if (document.fullscreenElement) return 1; },  
 33844: () => { return document.getElementById('canvas').width; },  
 33896: () => { return parseInt(document.getElementById('canvas').style.width); },  
 33964: () => { document.exitFullscreen(); },  
 33991: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 34049: () => { return screen.width; },  
 34074: () => { return screen.height; },  
 34100: () => { return window.screenX; },  
 34127: () => { return window.screenY; },  
 34154: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 34207: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 34278: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 34335: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 34591: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 34662: () => { if (document.fullscreenElement) return 1; },  
 34708: () => { return window.innerWidth; },  
 34734: () => { return window.innerHeight; },  
 34761: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
