...
// include: /tmp/tmpromso5bt.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/template/game.data';
...
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/template/game.data');

      };
      Module['addRunDependency']('datafile_build_web/template/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/shared/puffer.glb", "start": 0, "end": 1199624}, {"filename": "/resources/shared/puffers.png", "start": 1199624, "end": 1496762}, {"filename": "/resources/shared/puffers_128.png", "start": 1496762, "end": 1519668}], "remote_package_size": 1519668});

  })();

// end include: /tmp/tmpromso5bt.js
// include: /tmp/tmp4qkg0d7w.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp4qkg0d7w.js
// include: /tmp/tmpzt84u9my.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpzt84u9my.js
...
var ASM_CONSTS = {
  30144: () => { if (document.fullscreenElement) return 1; },  
 30190: () => { return document.getElementById('canvas').width; },  
 30242: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30310: () => { document.exitFullscreen(); },  
 30337: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30410: () => { if (document.fullscreenElement) return 1; },  
 30456: () => { return document.getElementById('canvas').width; },  
 30508: () => { return screen.width; },  
 30533: () => { document.exitFullscreen(); },  
 30560: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30693: () => { return window.innerWidth; },  
 30719: () => { return window.innerHeight; },  
 30746: () => { if (document.fullscreenElement) return 1; },  
 30792: () => { return document.getElementById('canvas').width; },  
 30844: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30912: () => { if (document.fullscreenElement) return 1; },  
 30958: () => { return document.getElementById('canvas').width; },  
 31010: () => { return screen.width; },  
 31035: () => { return window.innerWidth; },  
 31061: () => { return window.innerHeight; },  
 31088: () => { if (document.fullscreenElement) return 1; },  
 31134: () => { return document.getElementById('canvas').width; },  
 31186: () => { return screen.width; },  
 31211: () => { document.exitFullscreen(); },  
 31238: () => { if (document.fullscreenElement) return 1; },  
 31284: () => { return document.getElementById('canvas').width; },  
 31336: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31404: () => { document.exitFullscreen(); },  
 31431: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 31489: () => { return screen.width; },  
 31514: () => { return screen.height; },  
 31540: () => { return window.screenX; },  
 31567: () => { return window.screenY; },  
 31594: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31647: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 31718: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 31775: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32031: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 32102: () => { if (document.fullscreenElement) return 1; },  
 32148: () => { return window.innerWidth; },  
 32174: () => { return window.innerHeight; },  
 32201: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
