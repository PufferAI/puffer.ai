...
// include: /tmp/tmp0jcgokej.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/squared/game.data';
...
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/squared/game.data');

      };
      Module['addRunDependency']('datafile_build_web/squared/game.data');
...
// end include: /tmp/tmp0jcgokej.js
// include: /tmp/tmpg82neshv.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpg82neshv.js
// include: /tmp/tmpgmw5ab3f.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpgmw5ab3f.js
...
var ASM_CONSTS = {
  30112: () => { if (document.fullscreenElement) return 1; },  
 30158: () => { return document.getElementById('canvas').width; },  
 30210: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30278: () => { document.exitFullscreen(); },  
 30305: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30378: () => { if (document.fullscreenElement) return 1; },  
 30424: () => { return document.getElementById('canvas').width; },  
 30476: () => { return screen.width; },  
 30501: () => { document.exitFullscreen(); },  
 30528: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 30661: () => { return window.innerWidth; },  
 30687: () => { return window.innerHeight; },  
 30714: () => { if (document.fullscreenElement) return 1; },  
 30760: () => { return document.getElementById('canvas').width; },  
 30812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30880: () => { if (document.fullscreenElement) return 1; },  
 30926: () => { return document.getElementById('canvas').width; },  
 30978: () => { return screen.width; },  
 31003: () => { return window.innerWidth; },  
 31029: () => { return window.innerHeight; },  
 31056: () => { if (document.fullscreenElement) return 1; },  
 31102: () => { return document.getElementById('canvas').width; },  
 31154: () => { return screen.width; },  
 31179: () => { document.exitFullscreen(); },  
 31206: () => { if (document.fullscreenElement) return 1; },  
 31252: () => { return document.getElementById('canvas').width; },  
 31304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31372: () => { document.exitFullscreen(); },  
 31399: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 31457: () => { return screen.width; },  
 31482: () => { return screen.height; },  
 31508: () => { return window.screenX; },  
 31535: () => { return window.screenY; },  
 31562: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31615: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 31686: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 31743: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 31999: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 32070: () => { if (document.fullscreenElement) return 1; },  
 32116: () => { return window.innerWidth; },  
 32142: () => { return window.innerHeight; },  
 32169: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
