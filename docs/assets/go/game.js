...
// include: /tmp/tmppuy9a8wn.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/go/game.data';
...
Module['FS_createPath']("/resources", "go", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/go/game.data');

      };
      Module['addRunDependency']('datafile_build_web/go/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/go/go_weights.bin", "start": 0, "end": 1019468}, {"filename": "/resources/shared/puffer.glb", "start": 1019468, "end": 2219092}, {"filename": "/resources/shared/puffers.png", "start": 2219092, "end": 2516230}, {"filename": "/resources/shared/puffers_128.png", "start": 2516230, "end": 2539136}], "remote_package_size": 2539136});

  })();

// end include: /tmp/tmppuy9a8wn.js
// include: /tmp/tmpfidz4sfe.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpfidz4sfe.js
// include: /tmp/tmp_hsqbk12.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp_hsqbk12.js
...
var ASM_CONSTS = {
  30464: () => { if (document.fullscreenElement) return 1; },  
 30510: () => { return document.getElementById('canvas').width; },  
 30562: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30630: () => { document.exitFullscreen(); },  
 30657: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30730: () => { if (document.fullscreenElement) return 1; },  
 30776: () => { return document.getElementById('canvas').width; },  
 30828: () => { return screen.width; },  
 30853: () => { document.exitFullscreen(); },  
 30880: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31013: () => { return window.innerWidth; },  
 31039: () => { return window.innerHeight; },  
 31066: () => { if (document.fullscreenElement) return 1; },  
 31112: () => { return document.getElementById('canvas').width; },  
 31164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31232: () => { if (document.fullscreenElement) return 1; },  
 31278: () => { return document.getElementById('canvas').width; },  
 31330: () => { return screen.width; },  
 31355: () => { return window.innerWidth; },  
 31381: () => { return window.innerHeight; },  
 31408: () => { if (document.fullscreenElement) return 1; },  
 31454: () => { return document.getElementById('canvas').width; },  
 31506: () => { return screen.width; },  
 31531: () => { document.exitFullscreen(); },  
 31558: () => { if (document.fullscreenElement) return 1; },  
 31604: () => { return document.getElementById('canvas').width; },  
 31656: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31724: () => { document.exitFullscreen(); },  
 31751: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 31809: () => { return screen.width; },  
 31834: () => { return screen.height; },  
 31860: () => { return window.screenX; },  
 31887: () => { return window.screenY; },  
 31914: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 31967: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 32038: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 32095: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32351: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 32422: () => { if (document.fullscreenElement) return 1; },  
 32468: () => { return window.innerWidth; },  
 32494: () => { return window.innerHeight; },  
 32521: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
