...
// include: /tmp/tmpz_rwokk9.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/cartpole/game.data';
...
Module['FS_createPath']("/resources", "cartpole", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/cartpole/game.data');

      };
      Module['addRunDependency']('datafile_build_web/cartpole/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/cartpole/cartpole_weights.bin", "start": 0, "end": 532492}, {"filename": "/resources/shared/puffers.png", "start": 532492, "end": 829630}, {"filename": "/resources/shared/puffers_128.png", "start": 829630, "end": 852536}], "remote_package_size": 852536});

  })();

// end include: /tmp/tmpz_rwokk9.js
// include: /tmp/tmpaabwmoce.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpaabwmoce.js
// include: /tmp/tmpwpueacos.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpwpueacos.js
...
var ASM_CONSTS = {
  30512: () => { if (document.fullscreenElement) return 1; },  
 30558: () => { return document.getElementById('canvas').width; },  
 30610: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30678: () => { document.exitFullscreen(); },  
 30705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30778: () => { if (document.fullscreenElement) return 1; },  
 30824: () => { return document.getElementById('canvas').width; },  
 30876: () => { return screen.width; },  
 30901: () => { document.exitFullscreen(); },  
 30928: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31061: () => { return window.innerWidth; },  
 31087: () => { return window.innerHeight; },  
 31114: () => { if (document.fullscreenElement) return 1; },  
 31160: () => { return document.getElementById('canvas').width; },  
 31212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31280: () => { if (document.fullscreenElement) return 1; },  
 31326: () => { return document.getElementById('canvas').width; },  
 31378: () => { return screen.width; },  
 31403: () => { return window.innerWidth; },  
 31429: () => { return window.innerHeight; },  
 31456: () => { if (document.fullscreenElement) return 1; },  
 31502: () => { return document.getElementById('canvas').width; },  
 31554: () => { return screen.width; },  
 31579: () => { document.exitFullscreen(); },  
 31606: () => { if (document.fullscreenElement) return 1; },  
 31652: () => { return document.getElementById('canvas').width; },  
 31704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31772: () => { document.exitFullscreen(); },  
 31799: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 31857: () => { return screen.width; },  
 31882: () => { return screen.height; },  
 31908: () => { return window.screenX; },  
 31935: () => { return window.screenY; },  
 31962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32015: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 32086: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 32143: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32399: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 32470: () => { if (document.fullscreenElement) return 1; },  
 32516: () => { return window.innerWidth; },  
 32542: () => { return window.innerHeight; },  
 32569: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
