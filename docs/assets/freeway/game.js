...
// include: /tmp/tmp6z7mbqka.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/freeway/game.data';
...
Module['FS_createPath']("/resources", "freeway", true, true);
Module['FS_createPath']("/resources", "shared", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/freeway/game.data');

      };
      Module['addRunDependency']('datafile_build_web/freeway/game.data');
    ...
    loadPackage({"files": [{"filename": "/resources/freeway/freeway_weights.bin", "start": 0, "end": 548368}, {"filename": "/resources/freeway/tex_car_body.png", "start": 548368, "end": 552821}, {"filename": "/resources/freeway/tex_car_wheels.png", "start": 552821, "end": 557029}, {"filename": "/resources/freeway/tex_chicken0.png", "start": 557029, "end": 559882}, {"filename": "/resources/freeway/tex_truck_body.png", "start": 559882, "end": 564121}, {"filename": "/resources/freeway/tex_truck_wheels.png", "start": 564121, "end": 568340}, {"filename": "/resources/shared/puffers.png", "start": 568340, "end": 865478}, {"filename": "/resources/shared/puffers_128.png", "start": 865478, "end": 888384}], "remote_package_size": 888384});

  })();

// end include: /tmp/tmp6z7mbqka.js
// include: /tmp/tmpgdgbtf6t.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpgdgbtf6t.js
// include: /tmp/tmpdss5x2mf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpdss5x2mf.js
...
var ASM_CONSTS = {
  36936: () => { if (document.fullscreenElement) return 1; },  
 36982: () => { return document.getElementById('canvas').width; },  
 37034: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37102: () => { document.exitFullscreen(); },  
 37129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 37202: () => { if (document.fullscreenElement) return 1; },  
 37248: () => { return document.getElementById('canvas').width; },  
 37300: () => { return screen.width; },  
 37325: () => { document.exitFullscreen(); },  
 37352: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 37485: () => { return window.innerWidth; },  
 37511: () => { return window.innerHeight; },  
 37538: () => { if (document.fullscreenElement) return 1; },  
 37584: () => { return document.getElementById('canvas').width; },  
 37636: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37704: () => { if (document.fullscreenElement) return 1; },  
 37750: () => { return document.getElementById('canvas').width; },  
 37802: () => { return screen.width; },  
 37827: () => { return window.innerWidth; },  
 37853: () => { return window.innerHeight; },  
 37880: () => { if (document.fullscreenElement) return 1; },  
 37926: () => { return document.getElementById('canvas').width; },  
 37978: () => { return screen.width; },  
 38003: () => { document.exitFullscreen(); },  
 38030: () => { if (document.fullscreenElement) return 1; },  
 38076: () => { return document.getElementById('canvas').width; },  
 38128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 38196: () => { document.exitFullscreen(); },  
 38223: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 38281: () => { return screen.width; },  
 38306: () => { return screen.height; },  
 38332: () => { return window.screenX; },  
 38359: () => { return window.screenY; },  
 38386: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 38439: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 38510: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 38567: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 38823: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 38894: () => { if (document.fullscreenElement) return 1; },  
 38940: () => { return window.innerWidth; },  
 38966: () => { return window.innerHeight; },  
 38993: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
